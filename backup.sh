...
##
# Отправляет команду stop в необходимую сессию. Заменить sessionName на название сессии. `echo -ne '\015'` позволяет эмитировать нажатие кнопки ввод
...
# Включаем наш сервер. sessionName заменить на название сессии. start.sh заменить на название скрипта запуска. `echo -ne '\015'` позволяет эмитировать нажатие кнопки ввод
